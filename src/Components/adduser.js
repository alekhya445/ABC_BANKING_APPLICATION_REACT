                    ...
                    <Card style={{ width: '24rem', backgroundColor: "aqua" }}>
                        ...
                        <Form onSubmit={e => onSubmit(e)}>
                            ...
                            <Form.Group controlId="formBasicMobile">
                                ...
                                <Form.Control type="number" placeholder="Mobile Number" name='phone' value={phone} onChange={e => onInputChange(e)} required/>

                            </Form.Group>
                            <Form.Group controlId="formBasicAdhar">
                                <Form.Label>Aadhar Number</Form.Label>
                                <Form.Control type="number" placeholder="AadharNumber" name='AadharNo' value={AadharNo} onChange={e => onInputChange(e)} required/>
                            ...
                            <Form.Group controlId="formBasicPassword">
                                ...
                                <Form.Control type="password" placeholder="Password" name='password' value={password} onChange={e => onInputChange(e)} required/>

                            </Form.Group>
                            <Form.Group controlId="formBasicPassword">
                                <Form.Label>Role</Form.Label>
                                <Form.Control type="text" placeholder="Role" name='role' value={role} onChange={e => onInputChange(e)} required/>
